...
```{r cluster_summary}
cluster_summary(duke_nicu_clean_2, cluster_2)
cluster_summary(duke_nicu_clean_2, cluster_4)
cluster_summary(duke_nicu_clean_2, cluster_5)
cluster_summary(duke_nicu_clean_2, cluster_7)
```
...
cluster4_summary <- duke_nicu_clean_2 %>%
  ...
  summarize(mean_ga = mean(gestational_age, na.rm = TRUE),
            ...
            pda_rate = mean(pda_2 == "Yes", na.rm = TRUE),
            mean_los = mean(length_of_stay, na.rm = TRUE)) %>%
  pivot_longer(-cluster_4, names_to = "measure", values_to = "value") %>%
